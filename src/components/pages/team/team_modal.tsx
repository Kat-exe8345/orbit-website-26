...
export default function TeamSection({
  ...
  return (
    <section className="relative w-full flex flex-1 flex-col shrink-0 justify-center items-center border-y border-[#0f0f0f]">
